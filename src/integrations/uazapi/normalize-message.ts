import { UazapiWebhookPayload } from "./schemas";
...
export function normalizeUazapiMessage(payload: UazapiWebhookPayload): NormalizedMessage {
  ...
  let messageType: NormalizedMessage["messageType"] = "unknown";
